...
patterns = [{"label": "frailes", "pattern": "frailes"},
        ...
        {"label": "av del rio", "pattern": [{"lower": "Avenida"}, {"lower": "del"},{"lower": "rio"}]},
        {"label": "interseccion turín", "pattern": "turín"},
        ...
        {"label": "parte baja jardin", "pattern": [{"lower": "parte"}, {"lower": "baja"},{"lower": "jardin"},{"lower": "1"}]},
        {"label": "parte baja jardin 1", "pattern": [{"lower": "jardin"}, {"lower": "1"}]},
        ...
        {"label": "avda. balalcazar", "pattern": [{"lower": "avenida"}, {"lower": "belalcazar"}]},
...
{"label": "w", "pattern": "w"},
{"label": "w", "pattern": [{"lower": "w"}, {"lower": "w"}]},
{"label": "w", "pattern": [{"lower": "w"}, {"lower": "w"},{"lower": "w"}]},
"""